...
DICTADO_SELECTOR_CONFIRMACION_ACTIVA = config(
    'DICTADO_SELECTOR_CONFIRMACION_ACTIVA',
    default=True,
    cast=bool,
)
...
PREINFORMES_GENERADOR_PLANTILLAS_IA_HABILITADO = config(
...
PREINFORMES_EMBEDDING_UMBRAL_PRECISO = config(
    'PREINFORMES_EMBEDDING_UMBRAL_PRECISO',
    default=0.50,
    cast=float,
)
